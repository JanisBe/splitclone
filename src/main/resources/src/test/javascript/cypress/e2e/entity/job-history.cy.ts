...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2023-02-04T17:59').blur().should('have.value', '2023-02-04T17:59');

      cy.get(`[data-cy="endDate"]`).type('2023-02-04T00:57').blur().should('have.value', '2023-02-04T00:57');
